...
const UserProfile = () => {
  ...
  useEffect(() => {
    const getUser = async () => {
      ...
      if (res) {
        console.log(res.users[0]); // Log the entire user object
        setUser(res.users[0]);
      }
    };
            ...
            <div className="row mt-2">
              ...
              <div className="col-md-4">
                <p className="mb-2">
                  ...
                  {user.address ? 
                    `${user.address.street ? user.address.street : "Street not available"} 
                    ${user.address.city ? user.address.city : "City not available"} 
                    ${user.address.pincode ? user.address.pincode : "Pincode not available"}` 
